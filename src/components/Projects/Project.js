        ...
        <React.Fragment>
            <div className={styles.projects}>
                ...
                <section className={styles.projectHeader}>
                    ...
                    <div>My works are comprised of a variety of some of the latest technologies and tools. Currently, I'm focused on creating mobile-responsive web applications.</div>
                </section>
            </div>
            <ProgrammingSkills />
